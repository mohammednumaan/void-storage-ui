    ...
    <>
      <div className={styles["file-folder-form-container"]}>
        <div className={styles["file-folder-form"]}>
          <form
            onSubmit={
              formType === "File" ? handleFileSubmit : handleFolderSubmit
            }
            method="POST"
            encType={
              formType === "File"
          ...
          >
            <label htmlFor="file-folder-input" id={styles["file-folder-label"]}>
              {formType === "File" ? "Upload File" : "Create Folder"}
            </label>
            <input
              disabled={disabled}
              onChange={
                formType === "File" ? handleFileInput : handleFolderInput
              }
              type={formType === "File" ? "file" : "text"}
              id={styles["file-folder-input"]}
              name={formType === "File" ? "file" : "newFolderName"}
