...
export default function Notification({notification, setNotifications}){
    ...
    return (
        <div className={`${styles["notification-container"]} ${notification.message && (lastUpdated === notification.time) ? styles["slidedown-animation"] : ''} ${isClosed && (lastUpdated !== notification.time) ? styles['slideup-animation'] : ''} `}>
